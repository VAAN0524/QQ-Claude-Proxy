...
def markdown_to_wechat_html(md_content, image_urls):
    ...
    for line in lines:
        ...
        # 替换章节配图 - 支持多种文件名格式
        # 匹配 ![描述](images/chapter01.png) 或 ![描述](images/chapter01_xxx.png)
        for img_file, url in image_urls.items():
            ...
            if match:
                ...
                patterns = [
                    rf'!\[([^\]]*)\]\(images/chapter{chapter_padded}\.png\)',  # chapter01.png
                    rf'!\[([^\]]*)\]\(images/chapter{chapter_padded}_[^.]+\.png\)',  # chapter01_xxx.png
                    rf'!\[([^\]]*)\]\(images/chapter{chapter_int}\.png\)',  # chapter1.png
                ]
...
def main():
    print("=" * 60)
    print("重新上传AI资讯文章到公众号草稿箱（修复图片显示）")
    print("=" * 60)
    print()
